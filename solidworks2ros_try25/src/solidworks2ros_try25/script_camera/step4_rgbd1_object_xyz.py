...
class HSVWithDepthXYZ:
    ...
    def __init__(self):
        ...
        # Topics
        self.rgb_topic    = rospy.get_param("~rgb_topic",    "/rgbd_camera1/rgb/image_raw")
        self.depth_topic  = rospy.get_param("~depth_topic",  "/rgbd_camera1/depth/image_raw")
        # Use the camera_info that matches the image you’re using for pixel indices.
        self.caminfo_topic = rospy.get_param("~camera_info", "/rgbd_camera1/rgb/camera_info")
...
if __name__ == "__main__":
    rospy.init_node("step4_rgbd1_object_xyz")
    HSVWithDepthXYZ()
    rospy.spin()